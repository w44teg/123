...
uint256 hashGenesisBlock("0x7cd1e9f3bee026e5feef97f0f3f26e78fe38b775c7fbe8f3590d426f8717ad22");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x5e2b2a94ee44c862dc92096f6f5557b15d44c82d80d197394339c887ee016856");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Putin became President on March 26";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 20 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04fff41b62a84f28896e4bdb39eab3b43d0e9df5eecad31e918e4356aee9e1ac3bab6e692c98d5d5a22090e4c469d80c0d6588ac4409d069dacea8da9c08a2a67c") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1533637333;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085025356;

        if (fTestNet)
        {
            block.nTime    = 1533637301;
            block.nNonce   = 385495996;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x167e5fd5286b4752808d31fe856cc50eea84a0449d132ea768683948b6626514"));
        block.print();
